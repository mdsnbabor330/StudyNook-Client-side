      ...
      <div className="flex items-center justify-center gap-4 border rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 w-120">
          <div className="max-w-md w-full mx-auto space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Enter your credentials to access your StudyNook account
              </p>
            </div>
          ...
          >
            ...
            >
              <Label>Email</Label>
              <Input className="placeholder:text-gray-300" placeholder="john@example.com" />
              <FieldError />
            </TextField>
            <TextField
              isRequired
            ...
            >
              ...
              <Input className="placeholder:text-gray-300" placeholder="Enter your password" />
